        ...
        <div class="divide-y divide-white/5">
            ...
            <form class="md:col-span-2 pl-20">
              <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                ...
                <div class="col-span-full">
                  ...
                  <div class="mt-2">
                    <input id="email" v-model="barObj.score" name="score" type="score" autocomplete="score"
                      class="block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset px-4 ring-white/10 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6" />
                  </div>
                </div>
                ...
                <div class="col-span-full">
                  ...
                  <div class="mt-2">
                    <select id="timezone" name="timezone"
                      ...
                      <option :selected="barObj.timezone == 'Pacific Standard Time'">Pacific Standard Time</option>
                      <option :selected="barObj.timezone == 'Eastern Standard Time'">Eastern Standard Time</option>
                      <option :selected="barObj.timezone == 'Greenwich Mean Time'">Greenwich Mean Time</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div class="mt-8 flex">
                <button type="submit" @click="updateProfile"
                  class="rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">Save</button>
              </div>
            </form>
          </div>
          ...
          <div class="grid max-w-7xl grid-cols-1 gap-x-8 mx-auto gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
            <div>
              ...
              <p class="mt-1 text-sm leading-6 text-gray-400">No longer want to use our service? You can delete your
            ...
            <div class="flex items-start md:col-span-2 pl-20 ">
              <button @click="deleteHandle" type="submit"
